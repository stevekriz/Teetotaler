...
const CustomDrawer = (props) => (
  <DrawerContentScrollView {...props}>
    <View style={{ backgroundColor: 'black', padding: 15 }}>
      ...
      >
        ...
        >
          <View>
            <Text style={{
              color: 'white', fontSize: 24, flex: 1, marginBottom: 5,
            }}
            >
              Steve Kriz
            </Text>
          ...
          >
            ...
            <Entypo name="star" size={15} color="lightgrey" style={{ marginLeft: 2 }} />
          </View>
        </View>
      </View>
      ...
      >
        <Pressable onPress={() => console.warn('Messages')} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ color: 'white', paddingVertical: 5 }}>Messages</Text>
          <Entypo name="chevron-thin-right" size={15} color="#ffffff" style={{ marginLeft: 2 }} />
        </Pressable>
      </View>
    ...
    <Pressable onPress={() => { Auth.signOut(); }}>
      <Text style={{ padding: 5, paddingLeft: 19, color: 'red' }}>Sign Out</Text>
    </Pressable>
